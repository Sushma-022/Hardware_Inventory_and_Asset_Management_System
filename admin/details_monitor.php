...
/* GET DATA */
$stmt = $conn->prepare("SELECT * FROM monitor WHERE serial_number = ?");
...
<div class="modern-card">
    <h2 class="modern-header">Monitor Specification</h2>
    <table>
        ...
        <tr><th>Screen Size</th><td><?= isset($row['size']) ? htmlspecialchars($row['size']) . ' Inch' : 'N/A' ?></td></tr>
